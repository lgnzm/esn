...
CREATE TABLE public.DEPT(
	...
	PDG        VARCHAR (20)  ,
	DG         VARCHAR (20)   ,
	CONSTRAINT DEPT_PK PRIMARY KEY (CODEPT)
)WITHOUT OIDS;
...
CREATE TABLE public.INGENIEUR(
	...
	SITUATION   VARCHAR (1)  ,
	CPT         FLOAT8    ,
	CONSTRAINT INGENIEUR_PK PRIMARY KEY (MLE)
)WITHOUT OIDS;
...
(53, 'BLASQUEZ', 'NICOLAS', '1500600000000', '1950-06-30 00:00:00', '01 19 04 56 78', 'Allée des Verdurins', '84300', 'CARPENTRAS', 'M', '0', 3.00000),
(54, 'HERNANDEZ', 'ANTOINE', '1510500000000', '1951-05-25 00:00:00', '01 90 84 83 79', 'La Bouteillonne', '84140', 'LE THOR', 'M', '0', 1.00000),
(55, 'MARCIER', 'JACQUES', '1470400000000', '1947-04-16 00:00:00', '01 90 26 78 90', 'Allés des rossignols', '84190', 'BEAUMES DE VENISE', 'M', '0', 3.00000),
...
(103, 'SOUPINACIO', 'JESUS', '1590900000000', '1959-09-15 00:00:00', NULL, '25 rue de la tête d or', '69006', 'LYON', 'M', '2', 5.00000),
...
(652, 'BIBER', 'ALBERT', '1570700000000', '1957-07-27 00:00:00', '01 45 85 47 52', '54 avenue de la grande Brière', '75000', 'PARIS', 'M', '2', 12.00000),
...
(691, 'THREAD', 'LINDA', '2580100000000', '1958-01-27 00:00:00', '01 90 39 92 01', '10 rue du lion enragé', '90000', 'BELFORT', 'F', '0', 24.00000),
...
(753, 'GAGARINE', 'JOSEPHA', '2770400000000', '1977-04-01 00:00:00', '01 68 57 84 93', '30 rue de la République', '91000', 'EVRY', 'F', '2', 2.00000),
...
(1211, 'EGLINGER', 'MARIE_DOMINIQUE', '2560400000000', '1956-04-10 00:00:00', '01 45 87 32 78', '12 rue du fer à moulin', '75005', 'PARIS', 'F', '1', 14.00000),
...
CREATE TABLE public.PROJET(
	...
	COUT       FLOAT8   ,
	TYPE       VARCHAR (2)   ,
	CONSTRAINT PROJET_PK PRIMARY KEY (CODPRO)

	,CONSTRAINT PROJET_TYPE_FK FOREIGN KEY (TYPE) REFERENCES public.TYPE(TYPE)
)WITHOUT OIDS;
...
-- Table: CLI_PRO
------------------------------------------------------------
CREATE TABLE public.CLI_PRO(
	CODPRO   INT  NOT NULL ,
	CODCLI   INT  NOT NULL  ,
	CONSTRAINT APPARTIENT_PK PRIMARY KEY (CODPRO,CODCLI)

	,CONSTRAINT CLI_PRO_PROJET_FK FOREIGN KEY (CODPRO) REFERENCES public.PROJET(CODPRO)
	,CONSTRAINT CLI_PRO_CLIENT0_FK FOREIGN KEY (CODCLI) REFERENCES public.CLIENT(CODCLI)
)WITHOUT OIDS;
...
CREATE TABLE public.EMPLOI(
	...
	DATSOR   DATE    ,
	CONSTRAINT EMPLOI_PK PRIMARY KEY (MLE,DATENT)

	,CONSTRAINT EMPLOI_INGENIEUR_FK FOREIGN KEY (MLE) REFERENCES public.INGENIEUR(MLE)
	,CONSTRAINT EMPLOI_DEPT0_FK FOREIGN KEY (CODEPT) REFERENCES public.DEPT(CODEPT)
)WITHOUT OIDS;
...
(690, '2007-01-01 00:00:00', 4, '2015-01-01 00:00:00'),
(690, '2025-01-02 00:00:00', 7, NULL),
...
(805, '2025-01-02 00:00:00', 12, NULL),
...
CREATE TABLE public.AFFECT(
	...
	FONCTION   VARCHAR (20)  ,
	PVENTE     FLOAT8    ,
	CONSTRAINT AFFECT_PK PRIMARY KEY (DATDEB,MLE)

	,CONSTRAINT AFFECT_PROJET_FK FOREIGN KEY (CODPRO) REFERENCES public.PROJET(CODPRO)
	,CONSTRAINT AFFECT_INGENIEUR0_FK FOREIGN KEY (MLE) REFERENCES public.INGENIEUR(MLE)
)WITHOUT OIDS;
...
(25, 17, 'ANALYSTE', '2025-01-01 00:00:00', NULL, 2500.00000),
...
(303, 2, 'ANALYSTE', '2025-01-01 00:00:00', NULL, 2210.00000),
...
-- Table: ING_PRO_CPC
------------------------------------------------------------
CREATE TABLE public.ING_PRO_CPC(
	MLE      INT  NOT NULL ,
	CODPRO   INT  NOT NULL ,
	COMPET   VARCHAR (20) NOT NULL  ,
	CONSTRAINT ING_PRO_CPC_PK PRIMARY KEY (MLE,CODPRO,COMPET)

	,CONSTRAINT EXERCE_INGENIEUR_FK FOREIGN KEY (MLE) REFERENCES public.INGENIEUR(MLE)
	,CONSTRAINT EXERCE_PROJET0_FK FOREIGN KEY (CODPRO) REFERENCES public.PROJET(CODPRO)
)WITHOUT OIDS;
...
-- Table: PRO_CPC
------------------------------------------------------------
CREATE TABLE public.PRO_CPC(
	CODPRO   INT  NOT NULL ,
	COMPET   VARCHAR (20) NOT NULL  ,
	CONSTRAINT PRO_CPC_PK PRIMARY KEY (CODPRO,COMPET)

	,CONSTRAINT PRO_CPC_PROJET_FK FOREIGN KEY (CODPRO) REFERENCES public.PROJET(CODPRO)
)WITHOUT OIDS;
...
-- Table: ING_CPC
------------------------------------------------------------
CREATE TABLE public.ING_CPC(
	COMPET   VARCHAR (20) NOT NULL ,
	MLE      INT  NOT NULL  ,
	CONSTRAINT ING_CPC_PK PRIMARY KEY (COMPET,MLE)
	,CONSTRAINT ING_CPC_INGENIEUR0_FK FOREIGN KEY (MLE) REFERENCES public.INGENIEUR(MLE)
)WITHOUT OIDS;
